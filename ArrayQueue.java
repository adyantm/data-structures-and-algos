...
/**
 * Your implementation of an cs1332hw03.ArrayQueue.
 *
...
public class ArrayQueue<T> {
    ...
    /*
     * The initial capacity of the cs1332hw03.ArrayQueue.
     *
    ...
    /**
     * Constructs a new cs1332hw03.ArrayQueue.
     */
    public ArrayQueue() {
    ...
    public void enqueue(T data) {
        ...
        if (size == backingArray.length) {
            ...
            for (int i = 0; i < backingArray.length; i++) {
                array[i] = backingArray[(front + i) % backingArray.length];
            }
            backingArray = array;
